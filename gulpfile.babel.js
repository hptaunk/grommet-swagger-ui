...
gulp.task('dist-css', () => {
  return gulp.src('src/scss/grommet-swagger-ui/index.scss')
    .pipe(sass({
...
//   if (process.env.CI) {
//     git.clone('https://' + process.env.GH_TOKEN + '@github.com/hptaunk/grommet-swagger-ui.git',
//       {
//         cwd: './tmp/'
//       },
//       (err) => {
...
//         process.chdir('./tmp/grommet-swagger-ui');
